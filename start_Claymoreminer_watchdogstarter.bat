...
EthDcrMiner64.exe -epool eu1.ethermine.org:4444 -ewal 0x7F5BB53c415334235a9E42eA03695F11b6553C0D -eworker rig4 -epsw x -dpool hub.miningpoolhub.com:20550 -dwal DiGiTalPaRa.44 -eworker DiGiTalPaRa.44 -dpsw x -dcoin sc -platform 2 -dbg -1 -r 1 -retrydelay 10 -ejobtimeout 1 -minspeed 14.000 -etht 1ms -eres 0 -ethi 16 -dcrt 5ms -etha 0 -mode 0 -mport 0 -allpools 1
